...
var lista = {extra: [{name: 'filters', text:'Try these filters: ' + filter('basic') + filter('hummus') + filter('jaffa') + filter('food') + filter('drink') + filter('street food')  + filter('club') + filter('24/7') + filter('saturday') + filter('transportation') + filter('SIM') + filter('co-working') + filter('all',''), tags:'*' },
    {name: 'Activities', text:'Some websites to help find events / activities / parties etc... <br> <a href="http://israel.dailysecret.com/telaviv/en" target="_blank">one</a><br><a target="_blank" href="https://www.secrettelaviv.com/">two</a><br><a target="_blank" href="http://activities.co.il/categories/%D7%9E%D7%A1%D7%99%D7%91%D7%94?lng=34.76501&lat=32.03954&h=%7B%22Sub%22%3A%7B%22%D7%9E%D7%A1%D7%99%D7%91%D7%94%22%3A%7B%7D%7D%7D&r=5&w=today&lang=en">three</a>', tags:'*' }],
		 ...
		 { realhours:
		   ...
		   name: 'knafe' },
                 {name:'Laundry place', map: 'http://google.com/maps?saddr=&daddr=' + encodeURIComponent('32.060411,34.772581') + '&dirflg=w', tags: 'basic,laundry', hours: 'workdays 10:00 - 20:00', text: 'a bit more expensive than the self service place, 7 shekels per kilo - but they do it for you...'},
		 {name: 'Self service laundry', map: 'http://google.com/maps?saddr=&daddr=' + encodeURIComponent('32.057211,34.770124') + '&dirflg=w', tags: 'basic,laundry', hours: '24/7?', text: 'it says its always open. maybe try calling the phone they put: 0532502356. Also - bring 5 shekel coins, it doesnt accept other types.', link: 'https://www.facebook.com/%D7%9E%D7%9B%D7%91%D7%A1%D7%AA-%D7%A4%D7%9C%D7%95%D7%A8%D7%A0%D7%98%D7%99%D7%9F-%D7%A9%D7%99%D7%A8%D7%95%D7%AA-%D7%A2%D7%A6%D7%9E%D7%99-231630666902088/info?tab=page_info' },
