...
var lista = {list: [
    {name: 'filters', text:'Try these filters: ' + filter('near') + filter('walking') + filter('jaffa') + filter('food') + filter('drink') + filter('street food')  + filter('club') + filter('24/7') + filter('transportation') + filter('SIM') + filter('all',''), tags:'*' },
