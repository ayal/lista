...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lista = React.createClass({
	    ...
	    contextTypes: {
	        router: React.PropTypes.fun.isRequired
	    },
	    ...
	    render: function render() {
	        ...
	        var lilista = _.map(lista.list, function (x) {
	            if (x.name && x.name.toLowerCase().match(that.props.term) || x.tags && x.tags.toLowerCase().match(that.props.term) || x.text && x.text.toLowerCase().match(that.props.term)) {
	                return React.createElement(
	                    ...
	                    React.createElement('div', { 'class': 'text', dangerouslySetInnerHTML: { __html: x.text } }),
	                    React.createElement(
	                        'div',
	                        { 'class': 'tags' },
	                        x.tags
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', placeholde: 'search', onChange: this.search, value: this.props.term })
	            ),
	            React.createElement(
	                'ul',
	                null,
	...
	var App = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(Lista, { nav: this.nav, term: query.term });
	    }
	});
